          ...
          element={
            <>
              ...
              <About
                ...
                moreInfo2="While I’ve gained a fair amount of experience in software development, I’m always aware that there’s so much more to learn. I’ve been able to deliver software solutions on time and have become familiar with several programming languages such as Javascript, React.js, Vue.js, .NET, .NET Core, C#, Python, Java, among others. I’ve also had the chance to be expose into software development methodologies like Agile and Scrum."
                ...
                moreInfo4="I’ve had some exposure to modern frameworks and technologies such as React and Vue in the area of web application development. I strive to create responsive and intuitive web applications that can enhance user experience and contribute to business growth."
